...
import { useGLTF, MeshReflectorMaterial, BakeShadows, Text } from '@react-three/drei'
  ...
  return (
    <Canvas shadows dpr={[1, 1.5]} camera={{ position: [-1.5, 1, 5.5], fov: 45, near: 1, far: 20 }} eventSource={document.getElementById('root')} eventPrefix="client">
      ...
      <group position={[-0, -1, 0]}>
        ...
        <Bun scale={0.4} position={[0, 0.3, 0.5]} rotation={[0, 0, 0]} />
...
function Bun(props) {
  return (
    <Text
      fontSize={1.4} // adjust font size as needed
      font="/Inter-Medium.woff" // provide the path to your font file
      color="#fff"
